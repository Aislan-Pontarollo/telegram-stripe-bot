...
// Mensagens padrão
const DEFAULT_MESSAGE_A = `👋 Ei! Vi que você começou aqui no BOTVP e deu uma olhada nas ofertas, mas não finalizou a compra. Posso tirar alguma dúvida rápida pra você?`;
